...
def generator_dataloader(data_file, batch_size, SEQ_LENGTH):
    token_stream = []
...
def discriminator_dataloader(real_file, fake_file, batch_size, SEQ_LENGTH):
    examples = []
    labels = []
